      ...
      <div className="main">
        ...
        <div className="container py-4 sm:py-16">
          ...
          <div className="flex flex-col items-center sm:flex-row sm:items-start gap-4 sm:gap-10 mt-6 sm:mt-10">
            ...
            <button onClick={swap} className="relative top-0 sm:top-4 flex justify-center items-center w-12 h-12 bg-indigo-600 hover:ring-8 hover:ring-indigo-100 rounded-full duration-75">
      ...
      <footer className="footer">
        <div className="container flex flex-col items-center py-6 border-t">
            ...
            <a href="https://github.com/bilalbentoumi/currency-converter" target="_blank">
              <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-6 h-6 mt-2">
